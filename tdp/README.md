...
The version 2.3.4-1.0 of Apache Hive is based on the `branch-2.3` tag of the Apache [repository](https://github.com/apache/spark/tree/branch-2.3).
...
The command generates a `.tar.gz` file of the release at `./spark-2.3.4-1.0-bin-tdp.tgz`.
